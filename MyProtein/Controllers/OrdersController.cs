...
namespace MyProtein.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(MyProteinContext context)
        {
            _context = context;
        }
        ...
        {
            var myProteinContext = _context.Orders.Include(o => o.PaymentMethod).Include(o => o.ShippingAddress).Include(o => o.ShippingMethod).Include(o => o.User);
            return View(await myProteinContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderId,UserId,OrderDate,Status,TotalAmount,ShippingAddressId,PaymentMethodId,ShippingMethodId,Notes,CreatedAt")] Order order)
        {
            ...
            ViewData["ShippingAddressId"] = new SelectList(_context.Addresses, "AddressId", "AddressId", order.ShippingAddressId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderId,UserId,OrderDate,Status,TotalAmount,ShippingAddressId,PaymentMethodId,ShippingMethodId,Notes,CreatedAt")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
